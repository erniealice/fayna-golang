...
import (
	...
	activitymaterialform "github.com/erniealice/fayna-golang/views/activity_material/form"
...
func buildFormData(record *activitymaterialpb.ActivityMaterial, routes fayna.ActivityMaterialRoutes, labels fayna.ActivityMaterialLabels) *activitymaterialform.Data {
	productName := ""
...
func buildEmptyFormData(activityID string, routes fayna.ActivityMaterialRoutes, labels fayna.ActivityMaterialLabels) *activitymaterialform.Data {
	return &activitymaterialform.Data{
		IsEdit:            false,
...
func addFormAction(routes fayna.ActivityMaterialRoutes) string {
	return routes.AddURL
}

// editFormAction returns the URL for the Edit form's hx-post attribute for a given activity ID.
func editFormAction(routes fayna.ActivityMaterialRoutes, activityID string) string {
	if activityID == "" {
