...
import (
	...
	taskoutcomedetail "github.com/erniealice/fayna-golang/domain/operation/task_outcome/detail"
	taskoutcomelist "github.com/erniealice/fayna-golang/domain/operation/task_outcome/list"
...
// TaskOutcomeModuleDeps holds all dependencies for the task outcome module.
type TaskOutcomeModuleDeps struct {
	Routes       taskoutcomepkg.Routes
	Labels       taskoutcomepkg.Labels
...
// TaskOutcomeModule holds all constructed task outcome views.
type TaskOutcomeModule struct {
	routes           taskoutcomepkg.Routes
	List             view.View
	Detail           view.View
	TabAction        view.View
...
// NewTaskOutcomeModule creates a new task outcome module with all views wired.
func NewTaskOutcomeModule(deps *TaskOutcomeModuleDeps) *TaskOutcomeModule {
	entityDeps := &taskoutcomepkg.ModuleDeps{
		Routes:              deps.Routes,
		Labels:              deps.Labels,
	...
	return &TaskOutcomeModule{
		...
		Add:              taskoutcomepkg.NewAddAction(entityDeps),
		Edit:             taskoutcomepkg.NewEditAction(entityDeps),
		Delete:           taskoutcomepkg.NewDeleteAction(entityDeps),
...
func (m *TaskOutcomeModule) RegisterRoutes(r view.RouteRegistrar) {
