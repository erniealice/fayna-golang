...
func testPhaseLabels() fayna.JobPhaseLabels {
	return fayna.JobPhaseLabels{
		Errors: fayna.JobPhaseErrorLabels{
...
func testPhaseRoutes() fayna.JobPhaseRoutes {
	return fayna.DefaultJobPhaseRoutes()
}
