...
type ListViewDeps struct {
	Routes               outcome_criteria.Routes
	...
	Labels               outcome_criteria.Labels
...
func criteriaColumns(l outcome_criteria.Labels) []types.TableColumn {
	return []types.TableColumn{
		{Key: "name", Label: l.Columns.Name},
		{Key: "type", Label: l.Columns.Type, WidthClass: "col-4xl"},
		{Key: "scope", Label: l.Columns.Scope, WidthClass: "col-3xl"},
...
func statusPageTitle(l outcome_criteria.Labels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l outcome_criteria.Labels, status string) string {
	switch status {
	case "active":
...
func emptyTitle(l outcome_criteria.Labels, status string) string {
	switch status {
	case "active":
...
func emptyMessage(l outcome_criteria.Labels, status string) string {
	switch status {
	case "active":
