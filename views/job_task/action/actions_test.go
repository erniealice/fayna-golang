...
func testTaskLabels() fayna.JobTaskLabels {
	return fayna.JobTaskLabels{
		Errors: fayna.JobTaskErrorLabels{
...
func testTaskRoutes() fayna.JobTaskRoutes {
	return fayna.DefaultJobTaskRoutes()
}
