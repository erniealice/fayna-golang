...
func buildStatusTabs(l fulfillment.Labels, routes fulfillment.Routes, activeStatus string) []StatusTab {
	statuses := []struct {
		key   string
		label string
	}{
...
func buildTableRows(rows []*fulfillmentpb.FulfillmentListRow, status string, l fulfillment.Labels, routes fulfillment.Routes, perms *types.UserPermissions) []types.TableRow {
