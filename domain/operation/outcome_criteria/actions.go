...
import (
	...
	outcomecriteriaform "github.com/erniealice/fayna-golang/domain/operation/outcome_criteria/form"
	...
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		if viewCtx.Request.Method == http.MethodGet {
			return view.OK("outcome-criteria-drawer-form", &outcomecriteriaform.Data{
				...
				TypeOptions:  outcomecriteriaform.DefaultTypeOptions(),
				ScopeOptions: outcomecriteriaform.DefaultScopeOptions(),
				Labels:       deps.Labels,
