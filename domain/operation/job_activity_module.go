...
import (
	...
	jobactivityaction "github.com/erniealice/fayna-golang/domain/operation/job_activity/action"
	jobactivitydetail "github.com/erniealice/fayna-golang/domain/operation/job_activity/detail"
	jobactivitylist "github.com/erniealice/fayna-golang/domain/operation/job_activity/list"
)

// JobActivityModuleDeps holds all dependencies for the job activity module.
type JobActivityModuleDeps struct {
	Routes       jobactivitypkg.Routes
	Labels       jobactivitypkg.Labels
	...
	ActivityLaborRoutes ActivityLaborRoutes
	...
	ActivityMaterialRoutes ActivityMaterialRoutes
	...
	ActivityExpenseRoutes ActivityExpenseRoutes
...
// JobActivityModule holds all constructed job activity views.
type JobActivityModule struct {
	routes              jobactivitypkg.Routes
	List                view.View
	Detail              view.View
	TabAction           view.View
...
// NewJobActivityModule creates the job activity module with all views wired.
func NewJobActivityModule(deps *JobActivityModuleDeps) *JobActivityModule {
...
func (m *JobActivityModule) RegisterRoutes(r view.RouteRegistrar) {
