...
import (
	...
	fulfillmentaction "github.com/erniealice/fayna-golang/domain/fulfillment/views/fulfillment/action"
	fulfillmentdashboard "github.com/erniealice/fayna-golang/domain/fulfillment/views/fulfillment/dashboard"
	fulfillmentdetail "github.com/erniealice/fayna-golang/domain/fulfillment/views/fulfillment/detail"
	fulfillmentlist "github.com/erniealice/fayna-golang/domain/fulfillment/views/fulfillment/list"
)

// ModuleDeps holds all dependencies for the fulfillment module.
type ModuleDeps struct {
	Routes       fulfillmentdomain.FulfillmentRoutes
	Labels       fulfillmentdomain.FulfillmentLabels
