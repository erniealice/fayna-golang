...
import (
	...
	jobsummary "github.com/erniealice/fayna-golang/domain/operation/views/outcome_summary/job_summary"
	summarylist "github.com/erniealice/fayna-golang/domain/operation/views/outcome_summary/list"
	phasesummary "github.com/erniealice/fayna-golang/domain/operation/views/outcome_summary/phase_summary"
)

// ModuleDeps holds all dependencies for the outcome summary module.
type ModuleDeps struct {
	Routes       operation.OutcomeSummaryRoutes
	Labels       operation.OutcomeSummaryLabels
