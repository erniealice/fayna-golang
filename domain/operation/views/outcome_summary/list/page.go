...
func summaryColumns(l operation.OutcomeSummaryLabels) []types.TableColumn {
...
func buildTableRows(summaries []*jobsumpb.JobOutcomeSummary, l operation.OutcomeSummaryLabels, routes operation.OutcomeSummaryRoutes) []types.TableRow {
