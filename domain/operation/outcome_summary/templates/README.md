...
- `subscription-group-download-drawer.html` renders the category, period, and CSV/PDF choices
  for a native browser download.
- `subscription_group.html`, `client-card.html`, and the summary templates render progressively
