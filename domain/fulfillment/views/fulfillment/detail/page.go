...
import (
	...
	fulfillment "github.com/erniealice/fayna-golang/domain/fulfillment"
...
type PageData struct {
	...
	Labels           fulfillment.FulfillmentLabels
	ActiveTab        string
...
func buildTabItems(l fulfillment.FulfillmentLabels, id string, routes fulfillment.FulfillmentRoutes) []pyeza.TabItem {
...
func buildItemsTable(items []*fulfillmentpb.FulfillmentItem, l fulfillment.FulfillmentLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildHistoryTable(events []*fulfillmentpb.FulfillmentStatusEvent, l fulfillment.FulfillmentLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildReturnsTable(returns []*fulfillmentpb.FulfillmentReturn, l fulfillment.FulfillmentLabels, tableLabels types.TableLabels) *types.TableConfig {
	_ = l // labels reserved for future use
	columns := []types.TableColumn{
