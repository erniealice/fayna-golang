...
func testPhaseLabels() operation.JobPhaseLabels {
	return operation.JobPhaseLabels{
		Errors: operation.JobPhaseErrorLabels{
...
func testPhaseRoutes() operation.JobPhaseRoutes {
	return operation.DefaultJobPhaseRoutes()
}
