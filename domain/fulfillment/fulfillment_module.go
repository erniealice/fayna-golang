...
import (
	...
	fulfillmentaction "github.com/erniealice/fayna-golang/domain/fulfillment/fulfillment/action"
	fulfillmentdashboard "github.com/erniealice/fayna-golang/domain/fulfillment/fulfillment/dashboard"
	fulfillmentdetail "github.com/erniealice/fayna-golang/domain/fulfillment/fulfillment/detail"
	fulfillmentlist "github.com/erniealice/fayna-golang/domain/fulfillment/fulfillment/list"
...
// FulfillmentModuleDeps holds all dependencies for the fulfillment module.
type FulfillmentModuleDeps struct {
	Routes       ffpkg.Routes
	Labels       ffpkg.Labels
...
// FulfillmentModule holds all constructed fulfillment views.
...
// NewFulfillmentModule creates a new fulfillment module with all views wired.
func NewFulfillmentModule(deps *FulfillmentModuleDeps) *FulfillmentModule {
...
func (m *FulfillmentModule) RegisterRoutes(r view.RouteRegistrar) {
	// Phase 3 — Pyeza dashboard block + per-app live dashboards plan.
