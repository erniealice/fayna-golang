...
type DetailViewDeps struct {
	...
	// Pass operation.DefaultActivityLaborRoutes() from composition.
	...
	// Pass operation.DefaultActivityMaterialRoutes() from composition.
	...
	// Pass operation.DefaultActivityExpenseRoutes() from composition.
