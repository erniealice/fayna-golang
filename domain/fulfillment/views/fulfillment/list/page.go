...
type ListViewDeps struct {
	Routes                     fulfillment.FulfillmentRoutes
...
func buildStatusTabs(l fulfillment.FulfillmentLabels, routes fulfillment.FulfillmentRoutes, activeStatus string) []StatusTab {
	statuses := []struct {
		key   string
		label string
	}{
...
func buildTableRows(rows []*fulfillmentpb.FulfillmentListRow, status string, l fulfillment.FulfillmentLabels, routes fulfillment.FulfillmentRoutes, perms *types.UserPermissions) []types.TableRow {
