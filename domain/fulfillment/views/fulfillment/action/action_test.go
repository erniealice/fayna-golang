...
func testLabels() fulfillment.FulfillmentLabels {
	return fulfillment.FulfillmentLabels{
		Errors: fulfillment.FulfillmentErrorLabels{
...
func testRoutes() fulfillment.FulfillmentRoutes {
	return fulfillment.DefaultFulfillmentRoutes()
}
