...
// routes.go — operation-domain route constants + route type aliases.
//
// Route constants are verbatim from the original routes.go. Route struct types
// are now type aliases pointing to the entity packages so that
// operation.JobRoutes == job.Routes, operation.JobActivityRoutes == job_activity.Routes, etc.
// This eliminates the duplicate struct definitions and breaks import cycles.
...
type JobRoutes = jobpkg.Routes
type JobPhaseRoutes = jobphasepkg.Routes
type JobTaskRoutes = jobtaskpkg.Routes
type JobTemplateRoutes = jobtemplatepkg.Routes
type JobTemplatePhaseRoutes = jobtemplatephasepkg.Routes
type JobTemplateTaskRoutes = jobtemplateTaskpkg.Routes
type JobActivityRoutes = jobactivitypkg.Routes
type ActivityLaborRoutes = activitylaborpkg.Routes
type ActivityMaterialRoutes = activitymaterialpkg.Routes
type ActivityExpenseRoutes = activityexpensepkg.Routes
...
func DefaultJobRoutes() JobRoutes               { return jobpkg.DefaultRoutes() }
func DefaultJobPhaseRoutes() JobPhaseRoutes      { return jobphasepkg.DefaultRoutes() }
func DefaultJobTaskRoutes() JobTaskRoutes        { return jobtaskpkg.DefaultRoutes() }
func DefaultJobTemplateRoutes() JobTemplateRoutes { return jobtemplatepkg.DefaultRoutes() }
func DefaultJobTemplatePhaseRoutes() JobTemplatePhaseRoutes {
	return jobtemplatephasepkg.DefaultRoutes()
}
func DefaultJobTemplateTaskRoutes() JobTemplateTaskRoutes {
	return jobtemplateTaskpkg.DefaultRoutes()
}
func DefaultJobActivityRoutes() JobActivityRoutes        { return jobactivitypkg.DefaultRoutes() }
func DefaultActivityLaborRoutes() ActivityLaborRoutes    { return activitylaborpkg.DefaultRoutes() }
func DefaultActivityMaterialRoutes() ActivityMaterialRoutes { return activitymaterialpkg.DefaultRoutes() }
func DefaultActivityExpenseRoutes() ActivityExpenseRoutes { return activityexpensepkg.DefaultRoutes() }
