...
func activityEntryTypeLabel(entryType string, l job_activity.Labels) string {
	switch entryType {
	case "labor":
...
func activityBillableStatusLabel(status string, l job_activity.Labels) string {
	switch status {
	case "included":
