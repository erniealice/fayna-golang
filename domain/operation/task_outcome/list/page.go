...
func NewView(deps *ListViewDeps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		if !perms.Can("task_outcome", "list") {
			return view.Forbidden("task_outcome:list")
		}
...
func outcomeColumns(l task_outcome.Labels) []types.TableColumn {
