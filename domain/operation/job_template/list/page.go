...
func jobTemplateColumns(l job_template.Labels) []types.TableColumn {
...
func statusTitle(l job_template.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l job_template.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l job_template.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l job_template.Labels, status string) string {
	switch status {
	case "active":
