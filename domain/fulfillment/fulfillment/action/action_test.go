...
func testLabels() fulfillment.Labels {
	return fulfillment.Labels{
		Errors: fulfillment.ErrorLabels{
...
func testRoutes() fulfillment.Routes {
	return fulfillment.DefaultRoutes()
}
