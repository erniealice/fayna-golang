...
type Deps struct {
	Routes operation.ActivityLaborRoutes
	Labels operation.ActivityLaborLabels
...
func buildFormData(record *activitylaborpb.ActivityLabor, routes operation.ActivityLaborRoutes, labels operation.ActivityLaborLabels) *activitylaborform.Data {
...
func buildEmptyFormData(activityID string, routes operation.ActivityLaborRoutes, labels operation.ActivityLaborLabels) *activitylaborform.Data {
	rateTypeLabels := activitylaborform.RateTypeLabels{
		Standard: labels.Form.RateTypeStandard,
		Overtime: labels.Form.RateTypeOvertime,
		Premium:  labels.Form.RateTypePremium,
...
func addFormAction(routes operation.ActivityLaborRoutes) string {
	return routes.AddURL
}

// editFormAction returns the URL for the Edit form's hx-post attribute for a given activity ID.
func editFormAction(routes operation.ActivityLaborRoutes, activityID string) string {
	if activityID == "" {
