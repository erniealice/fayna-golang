...
//
// No mapper: the Labels field is operation.OutcomeCriteriaLabels verbatim — templates
...
func DefaultTypeOptions(_ operation.OutcomeCriteriaLabels) []pyeza.SelectOption {
...
// The labels parameter is accepted for future i18n but currently unused.
func DefaultScopeOptions(_ operation.OutcomeCriteriaLabels) []pyeza.SelectOption {
	return []pyeza.SelectOption{
