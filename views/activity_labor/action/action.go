...
func buildFormData(record *activitylaborpb.ActivityLabor, routes fayna.ActivityLaborRoutes, labels fayna.ActivityLaborLabels) *activitylaborform.Data {
...
func buildEmptyFormData(activityID string, routes fayna.ActivityLaborRoutes, labels fayna.ActivityLaborLabels) *activitylaborform.Data {
	rateTypeLabels := activitylaborform.RateTypeLabels{
		Standard: labels.Form.RateTypeStandard,
		Overtime: labels.Form.RateTypeOvertime,
		Premium:  labels.Form.RateTypePremium,
...
func addFormAction(routes fayna.ActivityLaborRoutes) string {
	return routes.AddURL
}

// editFormAction returns the URL for the Edit form's hx-post attribute for a given activity ID.
func editFormAction(routes fayna.ActivityLaborRoutes, activityID string) string {
	if activityID == "" {
