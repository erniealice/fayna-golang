...
import (
	...
	jobaction "github.com/erniealice/fayna-golang/domain/operation/views/job/action"
	jobdashboard "github.com/erniealice/fayna-golang/domain/operation/views/job/dashboard"
	jobdetail "github.com/erniealice/fayna-golang/domain/operation/views/job/detail"
	joblist "github.com/erniealice/fayna-golang/domain/operation/views/job/list"
)

// ModuleDeps holds all dependencies for the job module.
type ModuleDeps struct {
	Routes       operation.JobRoutes
	Labels       operation.JobLabels
	...
	JobActivityRoutes operation.JobActivityRoutes
	JobActivityLabels operation.JobActivityLabels

	// Phase 3 — Pyeza dashboard block + per-app live dashboards plan.
	JobTemplateRoutes       operation.JobTemplateRoutes
