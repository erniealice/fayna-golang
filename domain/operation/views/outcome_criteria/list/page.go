...
func criteriaColumns(l operation.OutcomeCriteriaLabels) []types.TableColumn {
...
func buildTableRows(
	...
	status string,
	l operation.OutcomeCriteriaLabels,
	routes operation.OutcomeCriteriaRoutes,
...
func statusPageTitle(l operation.OutcomeCriteriaLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l operation.OutcomeCriteriaLabels, status string) string {
	switch status {
	case "active":
...
func emptyTitle(l operation.OutcomeCriteriaLabels, status string) string {
	switch status {
	case "active":
...
func emptyMessage(l operation.OutcomeCriteriaLabels, status string) string {
	switch status {
	case "active":
