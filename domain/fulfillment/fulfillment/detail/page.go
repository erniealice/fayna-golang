...
func buildTabItems(l fulfillment.Labels, id string, routes fulfillment.Routes) []pyeza.TabItem {
...
func buildItemsTable(items []*fulfillmentpb.FulfillmentItem, l fulfillment.Labels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildHistoryTable(events []*fulfillmentpb.FulfillmentStatusEvent, l fulfillment.Labels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildReturnsTable(returns []*fulfillmentpb.FulfillmentReturn, l fulfillment.Labels, tableLabels types.TableLabels) *types.TableConfig {
	_ = l // labels reserved for future use
	columns := []types.TableColumn{
